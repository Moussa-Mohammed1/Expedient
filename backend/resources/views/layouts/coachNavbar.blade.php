...
<script>
	document.getElementById('coach-mobile-menu-btn').addEventListener('click', function () {
		const menu = document.getElementById('coach-mobile-menu');
